...
/**
 * Builder for an Animation that creates an Animation from a properly formatted file.
 *
 * @param <Doc> the file to be used with the Builder for animation creation.
 */
public interface AnimationBuilder<Doc> {
  ...
  /**
   * Specify the bounding box to be used for the util.
