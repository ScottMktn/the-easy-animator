...
/**
 * A helper to read util data and construct an util from it.
 */
public class AnimationReader {
   ...
   * </p>
   *
   * @param readable The source of data for the util
   * @param builder  A builder for helping to construct a new util
   * @param <Doc>    The main model interface type describing animations
   * @return a Doc from built from a Readable.
   */
